...
testing_sample = tweets_rel.except_(training_sample).query("testing", "FROM testing USING SAMPLE 100 (reservoir, 43)")
...
search_result_rel = testing_with_embeddings_rel.project("internal_tweet_id, UNNEST(FAISS_SEARCH('flat', 5, emb)).label other_tweet_id").set_alias('search_result')
